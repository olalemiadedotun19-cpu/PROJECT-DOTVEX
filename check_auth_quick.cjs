...
(async () => {
  const r1 = await call('get_notebook_session_status', { request: { userName: 'olalemiadedotun', kernelSlug: 'dotvex-qwen3-gpu-v2' } });
  console.log('STATUS:', r1 && r1.content ? r1.content[0].text : JSON.stringify(r1));
  
  const r2 = await call('get_accelerator_quota', { request: {} });
  console.log('QUOTA:', r2 && r2.content ? r2.content[0].text : JSON.stringify(r2));
})();
