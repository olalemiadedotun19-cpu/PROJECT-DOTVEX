...
const notebook = {
  cells: [
    cell(['# Cell 1: Install ALL dependencies in one shot\n',
      'import subprocess, sys\n',
      'print("Installing deps...")\n',
      'cmds = [\n',
      '    [sys.executable, "-m", "pip", "install", "--quiet", "-U", "huggingface_hub"],\n',
      '    [sys.executable, "-m", "pip", "install", "--quiet", "--no-cache-dir", "llama-cpp-python", "--extra-index-url", "https://abetlen.github.io/llama-cpp-python/whl/cu128"],\n',
      '    [sys.executable, "-m", "pip", "install", "--quiet", "starlette-context", "fastapi", "uvicorn", "pydantic-settings"]\n',
      ']\n',
      'for cmd in cmds:\n',
    ...
    cell(['# Cell 2: Download Qwen2.5-1.5B-Instruct Q4_K_M\n',
      'import os\n',
      'from huggingface_hub import hf_hub_download\n',
      'model_path = "/kaggle/working/qwen2.5-1.5b-instruct-q4_k_m.gguf"\n',
      'if os.path.exists(model_path):\n',
      '    print("Model exists:", round(os.path.getsize(model_path)/1024/1024, 1), "MB")\n',
      'else:\n',
      ...
      '    )\n',
      '    print("Downloaded:", round(os.path.getsize(path)/1024/1024, 1), "MB")\n'
    ]),
    cell(['# Cell 3: Start llama.cpp server\n',
