...
const notebook = {
  cells: [
    cell(['# DOTVEX Qwen3 GPU Deployment - Single Shot (detached, no blocking loop)\n',
      'import subprocess, sys, os, time, urllib.request, json, signal, re\n',
      'print("=" * 60)\n',
      'print("DOTVEX Qwen3 GPU Deployment")\n',
      'print("=" * 60)\n',
      '\n',
      ...
      'print("[2/5] Downloading Qwen3-4B-Q4_K_M.gguf...")\n',
      ...
      '    print("  Model already exists: 2.33 GB")\n',
      'else:\n',
      ...
      '\n',
      '# Step 3: Start llama.cpp server (detached so it survives cell completion)\n',
      'print("[3/5] Starting llama.cpp server...")\n',
      'cmd = [\n',
      ...
      'print("[4/5] Testing local inference...")\n',
      ...
      '    sys.exit(1)\n',
      '\n',
      '# Step 5: Start Cloudflare tunnel (detached)\n',
      'print("[5/5] Starting Cloudflare tunnel...")\n',
      ...
      'print("  Waiting 25s for tunnel URL...")\n',
      'time.sleep(25)\n',
      '\n',
      'tunnel_url = None\n',
      ...
      '\n',
      'print("\\n" + "=" * 60)\n',
      'print("DEPLOYMENT COMPLETE (cell finished; server+tunnel run detached)")\n',
      'print("=" * 60)\n',
      'print(f"Server: http://127.0.0.1:8080")\n',
      'print(f"Tunnel: {tunnel_url or \'check /kaggle/working/tunnel_url.txt\'}")\n',
