...
(async () => {
  ...
  console.log('USER_PROFILE:', r1 && r1.content ? r1.content[0].text : JSON.stringify(r1));
  
  const r2 = await call('list_competitions', { request: { request: { group: 'General', category: 'GettingStarted', hasPage: true, hasPageSize: true, page: 1, pageSize: 1 } } });
  console.log('COMPETITIONS:', r2 && r2.content ? r2.content[0].text.substring(0, 500) : JSON.stringify(r2).substring(0, 500));
})();
