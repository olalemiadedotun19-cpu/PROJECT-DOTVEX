...
(async () => {
  // Try list_notebook_session_output directly - this worked earlier
  const r1 = await call('list_notebook_session_output', { request: { userName: 'olalemiadedotun', kernelSlug: 'dotvex-qwen3-gpu-v2' } });
  console.log('OUTPUT:', r1 && r1.content ? 'OK - length=' + r1.content[0].text.length : JSON.stringify(r1).substring(0, 300));
})();
