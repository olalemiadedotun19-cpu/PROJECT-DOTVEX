...
(async () => {
  ...
  console.log('OUTPUT_LENGTH:', out && out.content ? out.content[0].text.length : 0);
  if (out && out.content && out.content[0].text.length > 0) {
    console.log(out.content[0].text.substring(0, 2000));
  }
})();
