...
const notebook = {
  cells: [
    cell(['# Cell 1: Install dependencies and verify server is NOT already running\n',
    ...
    cell(['# Cell 2: Download exact Qwen3-4B-Q4_K_M.gguf (2.33 GB)\n',
      'import os, time\n',
      ...
      '    print(f"Model exists: {sz/1024/1024/1024:.2f} GB, match: {sz == expected_size}")\n',
      'else:\n',
      ...
      '    print(f"Downloaded: {sz/1024/1024/1024:.2f} GB in {elapsed:.0f}s ({sz/elapsed/1024/1024:.1f} MB/s)")\n',
      '    print(f"Size match: {sz == expected_size}")\n'
    ]),
    cell(['# Cell 3: Start llama.cpp server with CUDA\n',
    ...
    cell(['# Cell 4: Test inference with retries\n',
